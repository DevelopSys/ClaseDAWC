...
// CONCATENATED MODULE: ./src/componentes/coche.js
...
var Coche = /*#__PURE__*/function () {
  function Coche(modelo, marca, cv) {
    _classCallCheck(this, Coche);
  ...
  _createClass(Coche, [{
    ...
    value: function mostrarDatos() {
      console.log("".concat(this.marca, " ").concat(this.modelo, " ").concat(this.cv));
    }
  }]);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/componentes/operaciones.css
var operaciones = __webpack_require__(754);
// CONCATENATED MODULE: ./src/componentes/operaciones.css
;
...
var update = injectStylesIntoStyleTag_default()(operaciones/* default */.Z, options);



/* harmony default export */ const componentes_operaciones = (operaciones/* default.locals */.Z.locals || {});
// CONCATENATED MODULE: ./src/componentes/operaciones.js
;
function crearNodo() {
...
var coche = new Coche("Focus", "Ford", 123);
coche.mostrarDatos();
