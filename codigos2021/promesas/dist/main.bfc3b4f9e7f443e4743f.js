...
function _getCocheMatriculaAsync() {
  _getCocheMatriculaAsync = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(matricula) {
    var cocheEncontrado;
...
function _getAllCoches() {
  _getAllCoches = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2() {
    var cochesPromesas;
...
function _getAllCochesAwait() {
  _getAllCochesAwait = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3() {
    var cochesPromesas;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            cochesPromesas = [];
            coches.forEach(function (element) {
              var coche = getCocheMatricula(element.matricula);
              cochesPromesas.push(coche);
            });
            return _context3.abrupt("return", Promise.all(cochesPromesas));
...
console.time("normal");
getCocheMatricula("ASDASD").then(function (datos) {
  console.log("El coche encontrado es ".concat(datos));
})["catch"](function (err) {
  console.log(err);
});
console.timeEnd("normal");
console.time("async");
getCocheMatriculaAsync("4567GFD").then(function (data) {
  console.log(data);
})["catch"](function (err) {
  console.log(err);
});
...
console.time("todos");
getAllCoches().then(function (datos) {
  console.log(datos);
});
console.timeEnd("todos");
console.time("todosAwait");
getAllCochesAwait().then(function (datos) {
  console.log(datos);
});
