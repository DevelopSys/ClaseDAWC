...
/* unused reexport */ __webpack_require__(666);
...
;// CONCATENATED MODULE: ./src/services/repaso_promesas.js
...
function getCocheMatricula(matricula) {
  var cocheEncontrado;
  ...
  return new Promise(function (resolve, reject) {
    if (cocheEncontrado) {
      ...
      reject("No entrado coche con matr\xEDcula ".concat(matricula));
    }
  });
}
function getCocheMatriculaAsync(_x) {
  return _getCocheMatriculaAsync.apply(this, arguments);
}

function _getCocheMatriculaAsync() {
  _getCocheMatriculaAsync = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(matricula) {
    var cocheEncontrado;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", cocheEncontrado);

          case 5:
            throw "No entrado coche con matr\xEDcula ".concat(matricula);
...
function getAllCoches() {
  return _getAllCoches.apply(this, arguments);
}

function _getAllCoches() {
  _getAllCoches = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    var cochesPromesas;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            coches.forEach(function (element) {
              var coche;
              getCocheMatriculaAsync(element.matricula).then(function (dato) {
                coche = dato;
                cochesPromesas.push(coche);
              });
            });
            return _context2.abrupt("return", cochesPromesas);
...
function getAllCochesAwait() {
  return _getAllCochesAwait.apply(this, arguments);
}

function _getAllCochesAwait() {
  _getAllCochesAwait = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
    var cochesPromesas;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            cochesPromesas = [];
            coches.forEach(function (element) {
              var coche = getCocheMatriculaAsync(element.matricula);
              cochesPromesas.push(coche);
            });
            _context3.next = 4;
            return Promise.all(cochesPromesas);
...
function getCocheMatriculaAsyncAwait(_x2) {
  return _getCocheMatriculaAsyncAwait.apply(this, arguments);
}

function _getCocheMatriculaAsyncAwait() {
  _getCocheMatriculaAsyncAwait = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(matricula) {
    var cocheEncontrado;
...
;// CONCATENATED MODULE: ./src/services/conexiones_http.js




var url = "http://newsapi.org/v2/top-headlines?country=us&apiKey=3b9f157a5b75463189508b079bdbb25fwerwrwerwer";
var urlUsers = "https://reqres.in/api/";
var urlRandom = "https://randomuser.me/api/";
function getArticulos() {
  return _getArticulos.apply(this, arguments);
}

function _getArticulos() {
  _getArticulos = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var respuesta;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function getArticulosAjax() {
  return _getArticulosAjax.apply(this, arguments);
}

function _getArticulosAjax() {
  _getArticulosAjax = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            $.ajax({
              type: "GET",
              url: "http://newsapi.org/v2/top-headlines?country=us&apiKey=3b9f157a5b75463189508b079bdbb25f",
              data: "",
              dataType: "json",
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return $.ajax({
              type: "GET",
              url: "".concat(urlUsers, "users?page=2"),
              dataType: "json"
            });
...
function _createUser() {
  _createUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(usuario) {
    var respuesta;
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return $.post("".concat(urlUsers, "users"), usuario, "json");
...
function getUsersRandom(_x2) {
  return _getUsersRandom.apply(this, arguments);
}

function _getUsersRandom() {
  _getUsersRandom = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(numero) {
    var respuesta;
    return _regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            respuesta = $.get("".concat(urlRandom), {
              results: numero,
              gender: "female"
...
function pintarArticulo(articulo) {
  $(".row").append("<div class=\"card\" style=\"width: 18rem\">\n  <img src=".concat(articulo.urlToImage, " class=\"card-img-top\" alt=\"...\" />\n  <div class=\"card-body\">\n    <h5 class=\"card-title\">").concat(articulo.title, "</h5>\n    <p class=\"card-text\">\n    ").concat(articulo.description, "\n    </p>\n    <a href=\"").concat(articulo.url, "\" class=\"btn btn-primary\">Go somewhere</a>\n  </div>\n</div>"));
}
/*import {
  realizarPromesa,
