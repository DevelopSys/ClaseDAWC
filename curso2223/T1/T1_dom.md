...
El DOM de una página web es la estructura de nodos que permite la representación de los mismos dentro de un navegador. Por defecto este dom está establecido con los elementos que el programador web indica, pero mediante lenguajes como javascript es posible modificarlo. Para esta modificación se utilizan selectores para poder buscar determinados elementos, nodos que son los elementos que se incorporarán a la estructura de la página y eventos que son los disparadores que realizarán acciones tras una ejecución concreta
