...
Aquellos que tienen una representacion en byte dentro de la memoria del sistema operativo. Podemos diferenciar los siguientes
...
En el caso de querer mostrar por consola el tipo de una variable se pueden utilizar el operador typeof 
